...
const About = () => {
  const features = [
    "Certified professionals with specialized training",
    "Personalized care that adapts to your child's needs",
    "Convenient online sessions accessible anywhere",
    "Evidence-based therapeutic approaches",
    "Ongoing support for families and caregivers"
  ];

  return (
    <section id="about" className="py-20 bg-resonance-50">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-lg shadow-soft p-4 border border-resonance-100">
                <div className="flex items-center space-x-3">
                  <div className="flex -space-x-2">
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="w-10 h-10 rounded-full bg-resonance-100 border-2 border-white flex items-center justify-center text-resonance-600 font-bold">
                        T
                      </div>
                    ))}
                  </div>
          ...
          <AnimatedSection className="order-1 md:order-2">
            <div className="space-y-6">
              ...
              <div className="pt-4">
                <a 
                  href="#contact" 
                  className="inline-flex items-center px-6 py-3 rounded-full bg-resonance-600 text-white font-medium hover:bg-resonance-700 transition-all transform hover:-translate-y-1 shadow-md hover:shadow-lg"
                >
