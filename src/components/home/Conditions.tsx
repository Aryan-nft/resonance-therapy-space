...
const conditions = [
  ...
  },
  {
    ...
    therapies: [
      ...
      'Occupational Therapy (if there are any sensory issues)',
      'Speech Therapy (if needed)'
    ]
  },
  {
...
const Conditions = () => {
  ...
  return (
    <section className="py-20 bg-resonance-50">
        ...
        <AnimatedSection key={activeTab} className="bg-white rounded-2xl p-6 md:p-8 shadow-soft border border-gray-100">
          ...
          <div className="mb-6 border-b border-gray-200">
            <div className="flex space-x-4">
              {['description', 'causes', 'symptoms', 'therapies'].map((section) => (
                <button
                  key={section}
                  className={cn(
                    "px-4 py-2 border-b-2 text-sm font-medium transition-all",
                    activeSection === section
                      ? "border-resonance-600 text-resonance-700"
          ...
          <div className="min-h-[300px]">
            ...
            {activeSection === 'causes' && (
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {activeCondition?.causes.map((cause, index) => (
            ...
            {activeSection === 'symptoms' && (
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {activeCondition?.symptoms.map((symptom, index) => (
                    <div key={index} className="flex items-start">
                      <div className="mt-1 w-2 h-2 rounded-full bg-resonance-400 mr-2"></div>
            ...
            {activeSection === 'therapies' && (
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {activeCondition?.therapies.map((therapy, index) => (
                    <div key={index} className="bg-resonance-50 p-4 rounded-lg border border-resonance-100">
                ...
                <div className="mt-8">
                  <a 
                    href="#contact" 
                    className="inline-flex items-center px-5 py-2.5 rounded-lg bg-resonance-600 text-white font-medium hover:bg-resonance-700 transition-all"
                  >
                    Get Therapy Now
                  </a>
                </div>
